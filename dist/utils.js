...
export class ImageUtils {
    ...
    static createPieceImage(sourceImage, gridX, gridY, gridCols, gridRows) {
        ...
        ctx.drawImage(sourceImage, Math.max(0, sourceX), Math.max(0, sourceY), Math.min(sourceWidth, sourceImage.width - Math.max(0, sourceX)), Math.min(sourceHeight, sourceImage.height - Math.max(0, sourceY)), Math.max(0, -sourceX), Math.max(0, -sourceY), Math.min(sourceWidth, sourceImage.width - Math.max(0, sourceX)), Math.min(sourceHeight, sourceImage.height - Math.max(0, sourceY)));
